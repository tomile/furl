...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { agent_receiving_id: @notice.agent_receiving_id, commission: @notice.commission, referral_id: @notice.referral_id, status: @notice.status }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { agent_receiving_id: @notice.agent_receiving_id, commission: @notice.commission, referral_id: @notice.referral_id, status: @notice.status }
    assert_redirected_to notice_path(assigns(:notice))
  end
